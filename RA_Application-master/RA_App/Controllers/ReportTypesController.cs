...
namespace RA_App.Controllers
{
    public class ReportTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Report_ID,Category_Type,Name")] ReportType reportType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Report_ID,Category_Type,Name")] ReportType reportType)
        {
            if (ModelState.IsValid)
            {
